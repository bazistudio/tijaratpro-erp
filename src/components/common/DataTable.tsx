          ...
          <tr>
            {columns.map((col, index) => (
              <th
                key={col.key}
                scope="col"
                className={`px-4 py-3 text-xs font-semibold text-text-muted uppercase tracking-wider border-r border-border last:border-r-0 ${
                  index === 0 ? 'border-l-0' : ''
                }`}
              >
                {col.label}
          ...
          {isLoading ? (
            ...
            <tr>
              <td
                ...
                className="px-4 py-16 text-center text-text-muted border-b border-border"
              >
              ...
              >
                {columns.map((col, colIndex) => (
                  <td
                    ...
                    className={`px-4 py-2.5 text-text-primary border-r border-border last:border-r-0 ${
