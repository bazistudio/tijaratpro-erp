...
export const RevenueReport = ({ data, isLoading }: { data: any, isLoading: boolean }) => {
  return (
    <div className="bg-white shadow rounded-lg p-6 mb-6">
      <h3 className="text-lg font-medium text-gray-900 mb-4 border-b pb-2">Revenue Report</h3>
      {isLoading ? (
